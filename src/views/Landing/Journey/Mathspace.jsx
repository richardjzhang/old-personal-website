...
export const MathspaceCard = () => (
  <Fade delay={FADE_DELAY}>
    <Card title={TITLE} label={LABEL} image={<Image />}>
      ...
      address student needs. Working in a fast paced and agile environment
      allows me to roll these product changes out quickly and see the broader
      impacts my work has on mathematics education.
    </Card>
  </Fade>
);
