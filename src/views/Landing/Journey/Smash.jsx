...
export const SmashCard = () => (
  <Card title={TITLE} label={LABEL} image={<Image />}>
    ...
    During my time here, the structure of SMASH! was undergoing immense change.
    I was lucky enough to be part of the Treasury team to help oversee and
    implement these some of these changes, such as the development of an
